...
function bgImage() {
  if (window.main_image_url) {
    ...
    var mainImage = window.main_image_url;
...
function moveRadiosElements() {
  ...
  var giveMonthly = document.querySelector(".at-radio-label-4"); // Move Radio description outside radios div
  ...
  giveMonthly.textContent = "Give Monthly"; // Add radios indicator div
